// UI for players to place their 4 ships on the board using drag-and-drop,
...
public class ShipPlacementScreen extends JFrame 
{
    ...
    private class BoardPanel extends JPanel 
    {
         ...
         * Returns true if ship was successfully placed and false if not
         */
                ...
                if (draggedShip != null && draggedShip.isBeingDragged) {
                    ...
                    if (boardMouse != null) {
                        ...
                        if (hoverComp instanceof CellButton) {
                            ...
                            // Draw green if valid placement and draw red if invalid
                            if (isPreviewCell) {
...
private class ShipContainer extends JPanel 
{
    ...
    // Resets the ship and re-enable button
    public void reset() 
    {
        ship.reset();
    ...
    // Creates a draggable ship that can be placed on the board
